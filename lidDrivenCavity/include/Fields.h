...
class Fields
{
    public:
       ...
       typedef vector<Fields::vectorField> listVectorField;
        ...
        void dirichletBoundary(Fields::vectorField&,string&, double&);
        void oscillatingValueBoundary(Fields::vectorField&,string&, double&, double&,double&);
        void extaraPolateZeroGrad(Fields::vectorField&,vector<double>&,vector<double>&,string&);
